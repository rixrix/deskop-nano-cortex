...
**Prerequisites:** Node 20+, Rust 1.77+ (stable), and the Tauri platform deps for your OS
([macOS: Xcode CLT](https://tauri.app/start/prerequisites/) · Windows: WebView2 + MSVC · Linux: `webkit2gtk-4.1`, `libayatana-appindicator3`, `librsvg2`).
...
| Area              | Detail                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Unsigned build    | v1.0.0 is unsigned. macOS and Windows will show trust prompts; see [Installation](#installation). Signing infra is wired for a later signed release.                                                                                                                                                                                                                                                                                                                                                 |
