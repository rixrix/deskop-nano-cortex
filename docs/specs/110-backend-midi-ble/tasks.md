...
| 2026-07-15 | Fix capture-slot select frame (18 04 zero-based; 18 01 bypass only)                   | Coded              | docs/specs/110-backend-midi-ble/spec.md, backend/src/infrastructure/midi/ble_encoder.rs, frontend/src/features/midi/components/GearRotaryReadout.tsx                                                                                                                                                                                   | [x]   | [x]   |
| 2026-07-15 | Dump field 11 = rotary position (not absolute capture slot): resolve absolute by name | Coded              | docs/specs/110-backend-midi-ble/spec.md, frontend/src/app/App.tsx                                                                                                                                                                                                                                                                      | [x]   | [x]   |
