...
| FR-29 | `.tool-versions` pinning nodejs 20 and rust 1.77.0 for asdf/mise users, consistent with `.nvmrc` and `backend/rust-toolchain.toml`.                                                                                                                                                                                                                                                                                                          | Could Have  |
...
- [ ] `.tool-versions` pins `nodejs 20` and `rust 1.77.0`, consistent with `.nvmrc` and `backend/rust-toolchain.toml` (FR-29).
...
- **Rust toolchain**: stable (pinned via `backend/rust-toolchain.toml`); `cargo fmt` and `cargo clippy` ship with the toolchain.
...
| `.tool-versions`                                   | [FR-29]                     | asdf/mise pins: nodejs 20, rust 1.77.0                                                                                                                                  | —                                  | nvm-only users (`.nvmrc`)   |
